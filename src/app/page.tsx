...
export default function Home() {
  return (
   <div className="overflow-x-clip  ">
    <div className= " h-[853px] hidden lg:block  flex  mt-2 lg:h-[663px] lg:mt-10 lg:w-[1440px] "  style={{background: "#F2F0F1"} }>

  <div>
  {/* <p className="font-integral font-bold leading-[34px] smMax:w-[320px] w-[315px] text-[36px] smMax:text-[25px]  ml-4  mt-6 lg:hidden">
...
{/* Desktop */}
   ...
   <span className="lg:block">YOUR STYLE</span>
    ...
    <p className="lg:relative lg:z-10 ml-4 text-[14px] smMax:w-[280px] lg:text-[16px] lg:ml-[110px]"  style={{color:": #00000099"}}>
   ...
   <div className="lg:relative lg:z-10 text-center lg:mr-[1060px] smMax:mr-8">
   <button className="bg-black text-white text-center py-2 px-6 rounded-3xl smMax:w-[250px]   mx-auto mt-8 w-[350px] lg:w-44 lg:h-12">
  Shop Now
</button>
   </div>
...
<div className="">
  ...
  <Image src={"/hero1.png"} width={390} height={448} alt={"menu"} className="lg:hidden smMax:w-[310px] "></Image>
...
<div className="w-[390px] h-[146px] smMax:  -mt-60 lg:mt-0  bg-black lg:w-[1440px] lg:h-[122px]  ">
...
<div className="flex justify-around smMax:flex smMax:-space-x-14 lg:hidden">
...
<StayPage/>
  ...
  <div className="flex justify-center items-center lg:hidden overflow-x-clip">
  <div
    className=" flex flex-col mt-2 smMax:h-[790px] h-[853px] lg:mt-10 max-w-[1023px] w-full"
    style={{ background: "#F2F0F1" }}
  >
    <p className="space-x-2 font-integral font-bold leading-[34px] text-[36px] ml-4 mt-6">
      <span>FIND CLOTHES </span>
      <span className="lg:block">THAT </span>
      <span className="lg:block">MATCHES YOUR STYLE</span>
    </p>

    <div className=" mt-4">
    <p className="lg:relative lg:z-10 ml-4 text-[14px] lg:hidden sm:text-[16px] md:text-[20px] h-[50px] smMax:w-[280px] w-[358px] sm:w-[458px]"  style={{color:": #00000099"}}>
...
<span className="lg:block">to bring out your individuality and cater to your sense of style.</span>
  ...
  <Image src={"/dsright.png"} width={76} height={76} alt={"menu"} className="lg:hidden smMax:-mt-80 smMax:ml-56 md:ml-[440px] md:w-36 md:-mt-[440px] md:h-32 -mt-96 ml-72"></Image>
  <Image src={"/dsleft.png"} width={44} height={44} alt={"menu"} className=" lg:hidden  smMax:ml-0 ml-4 md:w-20 "></Image>
  <Image src={"/dsright.png"} width={104} height={104} alt={"menu"} className="hidden lg:block lg:ml-[1255px] -mt-[550px]"></Image>
  <Image src={"/dsleft.png"} width={56} height={56} alt={"menu"} className=" hidden lg:block lg:ml-[750px] mt-[40px]"></Image>
...
<div className=" h-[146px] pt-6 mt-[260px]  mx-auto md:mt-[220px] max-w-[1023px] smMax:mt-[200px] w-full lg:mt-0  bg-black  ">
            ...
            <p className="font-satoshi text-[14px] lg:text-[16px] font-normal text-gray-400">
              {`"Im blown away by the quality and style of the clothes
               I received from Shop.co. From casual wear to elegant dresses every piece Ive bought has exceeded my expectations.”`}
                ...
                <div className="max-w-[1023px] w-full h-[846px] mx-auto bg-lightGray lg:mt-[200px] mt-[150px]   ">

<div className="flex justify-center items-center ">
<div className="w-[358px] md:w-[458px] h-[293px] lg:w-[1240px] lg:h-[180px]   flex justify-center rounded-[20px] -ml-1 -mt-[100px] bg-black">
...
{/*             
 ...
 <div className="lg:hidden mx-auto  -mt-[650px]">
